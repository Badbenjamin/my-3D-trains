...
def return_sorted_trains_or_trip_error(leg_info, start_station_id, end_station_id, time=(round(current_time.timestamp()))):
    ...
    print('inside sorted trains or trip error')
...
def handle_multi_leg_trip(train_data_obj):
    ...
    print('leg1', leg_one)
    trip_sequence.append(return_sorted_trains_or_trip_error(leg_one, train_data_obj.start_station_id, train_data_obj.end_station_id))
...
def build_trip_sequence(journey_obj, train_data_obj):
    ...
    if journey_obj.shared_stations == []:
        ...
        # print('leg', leg)
        trip_sequence.append(return_sorted_trains_or_trip_error(leg, train_data_obj))
    else:
